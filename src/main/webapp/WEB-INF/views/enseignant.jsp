                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Gestion des personnels
                            </li>
                        </ol>
                    </div>
                </div>
...
<table>
	...
	<tr>
		...
		<td>
			<form:input cssStyle="width:220px"  path="name" class="form-control"/>
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		...
		<td>
			<form:input  cssStyle="width:220px"  path="login" class="form-control"/>
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>
			<form:input cssStyle="width:220px"  path="password" class="form-control"/>
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>
			<form:select cssStyle="width:220px"  class="form-control" id="SelectList" path="personType" >
               <form:options />         
            </form:select>
		</td> 
	</tr>
	<tr>
		<td colspan="2">
			<c:if test="${!empty enseignant.code}">
				<input type="submit"
					value="<spring:message text="Editer Enseignant"/>" />
			</c:if>
			<c:if test="${empty enseignant.code}">
				<input type="submit"
...
<c:if test="${!empty listEnseignants}"> <div class="col-lg-10">
        	<div class="panel panel-default">
            <div class="panel-heading"><h3>Enseignants</h3><input type="text" id="myInput" onkeyup="myFunction()" placeholder="nom.."></div>
...
<thead>
	<tr >
     ...
     <tbody>
	<c:forEach items="${listEnseignants}" var="etudiant">
		<tr>
			<td>${etudiant.id}</td>
			<td>${etudiant.code}</td>
			<td>${etudiant.name}</td>
			<td>${etudiant.email}</td>
			<td>${etudiant.personType}</td>
			<td><a href="<c:url value='/editEnseignant/${etudiant.id}' />" >Editer</a></td>
			<td><a href="<c:url value='/removeEnseignant/${etudiant.id}' />" >Supprimer</a></td>
		</tr>
	</c:forEach>
	  </tbody>
</table>
