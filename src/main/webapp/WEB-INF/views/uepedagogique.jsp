                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Gestion des unités pédagogiques
                            </li>
                        </ol>
                    </div>
                </div>
...
<c:if test="${!empty unites}">
	<div class="panel panel-default">
            <div class="panel-heading"><h3>Unités Pédagogiques</h3><!-- <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Recherche par code.."> --></div>
