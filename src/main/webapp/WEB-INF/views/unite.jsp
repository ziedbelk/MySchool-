...
<c:url var="addAction" value="/unite/add" ></c:url>
...
<table>
	...
	<tr>
		...
		<td>
			<form:input cssStyle="width:220px" path="id" readonly="true" size="8"  disabled="true" class="form-control"/>
			<form:hidden path="id" />
		</td> 
	</tr>
	</c:if>
	...
	<tr>
		<td colspan="2">
			<c:if test="${!empty unite.code}">
				<input type="submit"
					value="<spring:message text="Edit unite enseignement"/>" />
			</c:if>
			<c:if test="${empty unite.code}">
				<input type="submit"
					value="<spring:message text="Add unite enseignement"/>" />
			</c:if>
		</td>
	</tr>
...
<br>
<c:if test="${!empty unites}"><div class="col-lg-10">
        	<div class="panel panel-default">
            <div class="panel-heading"><h3>Unites</h3></div> <div class="panel-body">
	<table id="myTable" class="table">
	<tr>
		<th width="80"> ID</th>
		<th width="120"> code</th>
		<th width="120">nbrHcours</th>
		<th width="60">Edit</th>
		<th width="60">Delete</th>
		<th width="150">Elements d'enseignement</th>
	</tr>
	<c:forEach items="${unites}" var="unite">
		<tr>
			<td>${unite.id}</td>
			<td>${unite.code}</td>
			<td>${unite.nbrHcours}</td>
		<%-- 	<td>${unite.classe.nomClasse}</td> --%>
			<td><a href="<c:url value='/editUnite/${unite.id}' />" >Edit</a></td>
			<td><a href="<c:url value='/removeUnite/${unite.id}' />" >Delete</a></td>
			<td><a href="<c:url value='/viewEeUe/${unite.id}' />" >Elements d'enseignement</a></td>
		</tr>
	</c:forEach>
	</table>
	      </div>
