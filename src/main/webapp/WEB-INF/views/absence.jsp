...
<c:url var="addAction" value="/absence/search" ></c:url>
...
<tr>
		...
		<td>
		    <div cssStyle="width:220px" class='input-group date' id='datetimepicker7'>
	...
	<tr>
		<td colspan="2">
				<input type="submit"
					value="<spring:message text="search Etudiant"/>" />
		</td>
	</tr>
...
<c:if test="${!empty listEtudiants}"><div class="col-lg-10">
	...
	<c:forEach items="${listEtudiants}" var="etudiant">
		<tr>
			...
			<td><a href="<c:url value='/markAbsent/${etudiant.id}' />"  >marquer absent</a></td>
			<td><a href="<c:url value='/markPresent/${etudiant.id}'  />" >marquer present</a></td>
		</tr>
	</c:forEach>
	</table>
</div>
