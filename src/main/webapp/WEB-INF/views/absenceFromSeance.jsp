                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Gestion des annees absences
                            </li>
                        </ol>
                    </div>
                </div>
	...
	<c:forEach items="${listEtudiants}" var="etudiant">
       ...
       <c:when test="${etudiant.absent==true}">
        <tr class="danger">
			...
			<td><a href="<c:url value='/markAbsentFromSeance/${etudiant.id}' />"  >marquer absent</a></td>
			<td><a href="<c:url value='/markPresentFromSeance/${etudiant.id}'  />" >marquer present</a></td>
		</tr>
       </c:when>    
       <c:otherwise>
         <tr class="success">
