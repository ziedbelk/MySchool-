    ...
    <div id="page-wrapper">
            <div class="container-fluid">
               <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Gestion des élements d'enseignement
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                ...
                <!-- /.row -->
<c:url var="addAction" value="/objectif/add" ></c:url>

<form:form action="${addAction}" commandName="objectif">
<table>
	...
	<tr>
		...
		<td>
			<form:input cssStyle="width:220px"  path="description" />
		</td> 
	</tr>
	...
	<tr>
		<td colspan="2">
			<c:if test="${!empty objectif.description}">
				<input type="submit"
					value="<spring:message text="Editer objectif"/>" />
			</c:if>
			<c:if test="${empty objectif.description}">
				<input type="submit"
					value="<spring:message text="Ajouter objectif"/>" />
			</c:if>
		</td>
	</tr>
...
<br>
<h3>Objectifs</h3>
<c:if test="${!empty objectifs}"><div class="col-lg-10">
	...
	<c:forEach items="${objectifs}" var="objectif">
		...
		<%-- 	<td>${unite.classe.nomClasse}</td> --%>
			<td><a href="<c:url value='/editObjectif/${objectif.id}' />" >Editer</a></td>
			<td><a href="<c:url value='/removeObjectif/${objectif.id}' />" >Supprimer</a></td>
		</tr>
	</c:forEach>
	</table>
</div>
