    ...
    <div id="page-wrapper">
            <div class="container-fluid">
               <div class="row">
                ...
                <!-- /.row -->
<c:url var="addAction" value="/seanceSearch" ></c:url>
...
<c:if test="${!empty listSeances}"><div class="col-lg-10">
	...
	<c:forEach items="${listSeances}" var="seance">
		<tr>
			...
			<td><a href="<c:url value='/confirmerSeancefc/${seance.id}' />" >Confirmer</a></td>
			<td><a href="<c:url value='/viewObjectifClasseRel/${seance.id}'/>" >Suivi objectifs</a></td>
