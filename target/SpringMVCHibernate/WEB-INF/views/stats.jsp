...
/* window.onload = function () {
        ...
        function drawChart() {
          var data = google.visualization.arrayToDataTable([
            ...
            ["1", ${fn:escapeXml(level1)}, "#b87333"],
            ["2", ${fn:escapeXml(level2)}, "silver"],
            ["3", ${fn:escapeXml(level3)}, "gold"],
            ["4", ${fn:escapeXml(level4)}, "color: #e5e4e2"],
            ["5", ${fn:escapeXml(level5)}, "silver"]
          ]);
    ...
    <div id="page-wrapper">
            <div class="container-fluid">
               <div class="row">
                ...
                <!-- /.row -->
                <c:url var="addAction" value="/searchStat" ></c:url>
...
<table>
	...
	<tr>
		<td colspan="2">
           ...
           <div id="columnchart_values" style="height: 300px; width: 90%;">
	</div> -->
