                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Unité pedagogique: enseignants
                            </li>
                        </ol>
                    </div>
                </div>
...
<c:url var="addAction" value="/upEnseignantRel/add" ></c:url>

<form:form action="${addAction}" commandName="upEnseignantRel">
<table>
	<c:if test="${!empty upEnseignantRel.enseignant}">
	<tr>
		<td>
			<form:label path="id">
	...
	<tr>
		...
		<td>
		    <form:select  cssStyle="width:220px" id="SelectList" items="${listElements}" itemLabel="code" itemValue="code"  path="enseignant.code" value="">
...
<c:if test="${!empty ups}"><div class="col-lg-10">
	...
	<c:forEach items="${ups}" var="up">
		<tr>
			<td>${up.id}</td>
			<td>${up.enseignant.code}</td>
			<td><a href="<c:url value='/removeEnseignantRel/${up.id}'/>" >Supprimer</a></td>
		</tr>
	</c:forEach>
	</table>
	</div>
